package fbo.costa.bootcampeveris.ui.challenge11
...
import fbo.costa.bootcampeveris.databinding.Challenge11FragmentBinding
...
@AndroidEntryPoint
class Challenge11Fragment : Fragment() {

    private var _binding: Challenge11FragmentBinding? = null
    private val binding get() = _binding!!

    private val viewModel: Challenge11ViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        _binding = Challenge11FragmentBinding.inflate(inflater, container, false)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return if (item.itemId == R.id.action_source) {
            OpenUrl.start(requireContext(), 11)
            true
