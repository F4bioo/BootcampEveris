...
import fbo.costa.bootcampeveris.databinding.Challenge5FragmentBinding
...
@AndroidEntryPoint
class Challenge5Fragment : Fragment(), TextWatcher {

    private var _binding: Challenge5FragmentBinding? = null
    private val binding get() = _binding!!

    private val viewModel: Challenge5ViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        _binding = Challenge5FragmentBinding.inflate(inflater, container, false)
    ...
    private fun setListeners() {
        ...
        binding.buttonRun.setOnClickListener {
            if (isNotEmpty()) {
                ...
                showMessage(getString(R.string.text_conditional_challenge5))
            }
        }
    }
