...
import fbo.costa.bootcampeveris.databinding.Challenge2FragmentBinding
...
@AndroidEntryPoint
class Challenge2Fragment : Fragment(), TextWatcher {

    private var _binding: Challenge2FragmentBinding? = null
    private val binding get() = _binding!!

    private val viewModel: Challenge2ViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        _binding = Challenge2FragmentBinding.inflate(inflater, container, false)
    ...
    private fun isMoreThanThousand() = binding.input.text.toString().trim().toInt() in 1..1000
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return if (item.itemId == R.id.action_source) {
            OpenUrl.start(requireContext(), 2)
            true
