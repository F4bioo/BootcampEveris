...
import fbo.costa.bootcampeveris.repository.RepositoryChallenge6
...
@HiltViewModel
class Challenge6ViewModel
@Inject constructor(
    private val repository: RepositoryChallenge6
) : ViewModel() {
